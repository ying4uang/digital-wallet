...
try:
    ...
    #for i in gr.getVertex(46702).get_first_connections():
    #    print i
    #print gr.bfs(46702,3289,4)
    ...
    with open(stream_file, 'rb') as f2:
        ...
        for line in f2:
            ...
            degree = gr.bfs(stream_vertex1,stream_vertex2,4)
            ...
            gr.addEdge(stream_vertex1,stream_vertex2)
